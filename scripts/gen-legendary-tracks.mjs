...
const ADDITIONS = [
  ...
  // ── Miami International Autodrome (USA) — extra laps reuse the Norris 2024 line ──
  {
    id: 'verstappen_miami_2023', driverId: 'verstappen', circuit: 'miami',
    circuitName: 'Miami International Autodrome', location: 'Miami, USA', year: 2023,
    name: 'Miami Grand Prix 2023', source: 'norris_miami_2024',
    lapTime: '1:28.200', sectors: { s1Time: 28.000, s2Time: 31.200, s3Time: 29.000 },
    topSpeed: 342, averageSpeed: 218,
    championshipPoints: [25, 44, 69, 93, 119, 144, 170, 195, 209, 234, 252, 277, 302, 327, 352, 377],
    description: "From ninth on the grid to a commanding win — Verstappen carved through the field on the Miami straights to underline a season of total dominance.",
  },
  {
    id: 'leclerc_miami_2022', driverId: 'leclerc', circuit: 'miami',
    circuitName: 'Miami International Autodrome', location: 'Miami, USA', year: 2022,
    name: 'Miami Grand Prix 2022', source: 'norris_miami_2024',
    lapTime: '1:28.796', sectors: { s1Time: 28.200, s2Time: 31.396, s3Time: 29.200 },
    topSpeed: 338, averageSpeed: 215,
    championshipPoints: [26, 45, 71, 104, 116, 138, 159, 170, 178, 186, 200, 219, 237, 252, 275, 290],
    description: "Pole position for the inaugural Miami Grand Prix — Leclerc led a Ferrari front-row lockout around the new Autodrome before Red Bull's race pace told.",
  },
  {
    id: 'sainz_miami_2022', driverId: 'sainz', circuit: 'miami',
    circuitName: 'Miami International Autodrome', location: 'Miami, USA', year: 2022,
    name: 'Miami Grand Prix 2022', source: 'norris_miami_2024',
    lapTime: '1:29.100', sectors: { s1Time: 28.300, s2Time: 31.600, s3Time: 29.200 },
    topSpeed: 337, averageSpeed: 214,
    championshipPoints: [0, 18, 33, 45, 58, 70, 76, 83, 95, 113, 133, 156, 171, 175, 187, 202],
    description: "A measured drive to the podium at the first Miami Grand Prix — Sainz backed up the Ferrari front row with a controlled third place on the bumpy street-style layout.",
  },
  {
    id: 'perez_miami_2023', driverId: 'perez', circuit: 'miami',
    circuitName: 'Miami International Autodrome', location: 'Miami, USA', year: 2023,
    name: 'Miami Grand Prix 2023', source: 'norris_miami_2024',
    lapTime: '1:28.500', sectors: { s1Time: 28.100, s2Time: 31.300, s3Time: 29.100 },
    topSpeed: 340, averageSpeed: 216,
    championshipPoints: [18, 36, 54, 72, 87, 105, 119, 137, 144, 162, 180, 198, 210, 228, 246, 264],
    description: "Pérez converted pole into the early lead at Miami and looked set for the win before his charging team-mate swept past — a sign of the title fight slipping away.",
  },
  // ── Räikkönen & Rosberg signature laps (reuse each circuit's existing line) ──
  {
    id: 'raikkonen_spa_2009', driverId: 'raikkonen', circuit: 'spa',
    circuitName: 'Circuit de Spa-Francorchamps', location: 'Stavelot, Belgium', year: 2009,
    name: 'Belgian Grand Prix 2009', source: 'leclerc_spa_2019',
    lapTime: '1:47.263', sectors: { s1Time: 33.000, s2Time: 42.263, s3Time: 32.000 },
    topSpeed: 332, averageSpeed: 233,
    championshipPoints: [0, 0, 4, 8, 11, 14, 18, 21, 27, 37, 43, 48, 48, 48, 48, 48],
    description: "A throwback win in a difficult Ferrari — Räikkönen used KERS and raw pace down the Kemmel straight to hold off Giancarlo Fisichella's Force India for victory at Spa.",
  },
  {
    id: 'raikkonen_suzuka_2005', driverId: 'raikkonen', circuit: 'suzuka',
    circuitName: 'Suzuka Circuit', location: 'Suzuka, Japan', year: 2005,
    name: 'Japanese Grand Prix 2005', source: 'schumacher_suzuka_2000',
    lapTime: '1:31.540', sectors: { s1Time: 35.000, s2Time: 38.540, s3Time: 18.000 },
    topSpeed: 315, averageSpeed: 230,
    championshipPoints: [6, 16, 26, 36, 49, 59, 69, 79, 91, 101, 104, 110, 112, 112, 112, 112],
    description: "One of the great drives — from seventeenth on the grid, Räikkönen carved through the field and took the lead with a last-lap pass on Fisichella into Turn 1 at Suzuka.",
  },
  {
    id: 'rosberg_monaco_2014', driverId: 'rosberg', circuit: 'monaco',
    circuitName: 'Circuit de Monaco', location: 'Monte Carlo, Monaco', year: 2014,
    name: 'Monaco Grand Prix 2014', source: 'senna_monaco_1984',
    lapTime: '1:18.500', sectors: { s1Time: 24.000, s2Time: 33.500, s3Time: 21.000 },
    topSpeed: 290, averageSpeed: 157,
    championshipPoints: [18, 33, 51, 79, 97, 122, 140, 159, 167, 192, 211, 229, 238, 256, 274, 317],
    description: "Pole and a controlled lights-to-flag win on the streets of Monaco — Rosberg's command of the principality, where he won three years running, was absolute.",
  },
  {
    id: 'rosberg_abu_dhabi_2016', driverId: 'rosberg', circuit: 'abu_dhabi',
    circuitName: 'Yas Marina Circuit', location: 'Abu Dhabi, UAE', year: 2016,
    name: 'Abu Dhabi Grand Prix 2016', source: 'verstappen_abu_dhabi_2021',
    lapTime: '1:43.120', sectors: { s1Time: 30.000, s2Time: 39.120, s3Time: 34.000 },
    topSpeed: 322, averageSpeed: 195,
    championshipPoints: [25, 43, 68, 93, 118, 138, 163, 188, 198, 223, 248, 268, 293, 318, 367, 385],
    description: "Second place was all he needed and second place is what he managed — through enormous late pressure, Rosberg held his nerve at Yas Marina to clinch the 2016 World Championship.",
  },
  {
    id: 'piastri_miami_2025', driverId: 'piastri', circuit: 'miami',
    circuitName: 'Miami International Autodrome', location: 'Miami, USA', year: 2025,
    name: 'Miami Grand Prix 2025', source: 'norris_miami_2024',
    lapTime: '1:27.900', sectors: { s1Time: 27.900, s2Time: 31.000, s3Time: 29.000 },
    topSpeed: 343, averageSpeed: 219,
    championshipPoints: [25, 44, 70, 89, 99, 131, 146, 161, 186, 198, 234, 250, 274, 291, 309, 336],
    description: "A controlled McLaren one-two led home by Piastri — he managed the pace at the front through the Miami heat to take a statement win in the championship fight.",
  },
]
