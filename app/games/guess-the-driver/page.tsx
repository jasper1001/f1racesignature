    ...
    <>
      ...
      <main className="pt-14 min-h-screen" style={{ background: '#f4f1ea' }}>
        ...
        <div className="relative border-b border-[#dcd5c6] py-16 px-6 text-center overflow-hidden">
          ...
          <Link
            href="/games"
            className="relative inline-flex items-center gap-1.5 text-[#1a1712] text-xs font-mono uppercase tracking-widest hover:text-[#f59e0b] transition-colors mb-6"
          >
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          <div className="rounded-2xl bg-[#fbf9f4] overflow-hidden p-5 md:p-8" style={{ border: '1px solid rgba(245,158,11,0.25)', boxShadow: '0 0 0 1px rgba(245,158,11,0.06), 0 0 40px rgba(245,158,11,0.06)' }}>
            <GuessTheDriverGame />
          </div>
