    ...
    <>
      ...
      <main className="pt-14 min-h-screen" style={{ background: '#030303' }}>
        ...
        <div className="max-w-5xl mx-auto px-6 py-12">
          <div className="rounded-2xl bg-[#060606] overflow-hidden p-5 md:p-8" style={{ border: '1px solid rgba(59,130,246,0.25)', boxShadow: '0 0 0 1px rgba(59,130,246,0.06), 0 0 40px rgba(59,130,246,0.06)' }}>
