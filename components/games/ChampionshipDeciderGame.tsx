        ...
        {(phase === 'question' || phase === 'answered') && current && (
          ...
          >
            ...
            <div className="flex items-center justify-between px-1">
              <span className="text-[#555555] text-xs font-mono">Scenario {index + 1} of {total}</span>
          ...
          return (
            ...
            >
              ...
              <div className="text-center space-y-1">
                <p className="text-[#555555] text-xs font-mono uppercase tracking-widest">Final Score</p>
                <motion.div
                ...
                >
                  ...
                  <span className="text-2xl text-[#333333] font-mono"> / {maxScore}</span>
                </motion.div>
              </div>
