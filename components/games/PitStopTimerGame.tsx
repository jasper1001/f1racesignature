...
export function PitStopTimerGame() {
  ...
  if (phase === 'intro') {
    return (
      <div className="flex flex-col items-center px-4 py-12 max-w-sm mx-auto">
        ...
        <p className="text-[#555555] text-sm mb-10 text-center">
          Can you release the car at the perfect moment?
        </p>

        {/* Difficulty */}
        <div className="w-full mb-6">
          <p className="text-[#252525] text-[10px] font-mono uppercase tracking-widest mb-2">Difficulty</p>
              ...
              <button
                ...
                className={`py-2.5 rounded-xl border text-sm font-medium transition-all ${
                  difficulty === d
                    ...
                    : 'text-[#333333] border-[#141414] bg-[#070707] hover:text-[#666666] hover:border-[#1f1f1f]'
                }`}
              >
                {CONFIGS[d].label}
              </button>
        ...
        <div className="w-full rounded-xl border border-[#0f0f0f] bg-[#060606] p-4 mb-8 space-y-2.5">
          {[
            { label: 'Target range',   value: `${cfg.targetMin.toFixed(2)}s – ${cfg.targetMax.toFixed(2)}s`, color: '#444444' },
            ...
            { label: 'Safe release',   value: `target − ${cfg.safeOffset.toFixed(2)}s min`,                   color: '#444444' },
          ].map(row => (
            <div key={row.label} className="flex justify-between items-center text-xs">
              <span className="text-[#252525]">{row.label}</span>
        ...
        {/* Rules */}
        <div className="w-full mb-10 space-y-2 text-sm text-[#333333]">
          <p>A target stop time is shown. Hit <span className="text-white">Release Car</span> as close to it as possible.</p>
          <p>
            Release too early →{' '}
  ...
  if (phase === 'countdown') {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[58vh] select-none">
        <p className="text-[#1e1e1e] text-[10px] font-mono uppercase tracking-widest mb-8">Get ready</p>
        <div
          className="text-[108px] font-bold leading-none tabular-nums transition-colors duration-200"
  ...
  if (phase === 'running') {
    return (
      ...
      >
        {/* Target */}
        <p className="text-[#222222] text-[10px] font-mono uppercase tracking-widest mb-1">Target Stop</p>
        <div
        ...
        {/* Live timer */}
        <p className="text-[#1a1a1a] text-[10px] font-mono uppercase tracking-widest mb-2">Pit Stop Timer</p>
        <div
        ...
        <p className="text-[#181818] text-[10px] font-mono uppercase tracking-widest mt-4">
      ...
      <div className="flex flex-col items-center px-4 py-10 text-center max-w-sm mx-auto">
        ...
        <div className="w-full space-y-3">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl border border-[#141414] text-[#333333] text-sm hover:text-white hover:border-[#252525] transition-all"
          >
            Change Difficulty
          </button>
        </div>
